...
class _BasePost extends _BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('link, short_content, content, title_tag, meta_keywords, meta_desc, created_date, modified_date, parent_id', 'safe'),
			array('title,post_type', 'required', 'on' => 'create, update'),
			...
			array('id,slug, title, short_content, content, status, posted_by, post_type, title_tag, meta_keywords, meta_desc, featured_image, display_order, created_date, modified_date, slug', 'safe', 'on' => 'search'),
			array('slug', 'safe'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'parent_id' => Yii::t('translation', 'Parent page'),
		);
	}
