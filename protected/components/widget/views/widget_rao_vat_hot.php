            ...
            { 
                ...
                if(!empty($index_) && !empty($arr_list[$index_]) )
                {
                    ...
                    echo '       
                            ...
                            if($index_%4==1)
                                echo '<div class="ad-square ad-regular" style="background-color: #FAF834">';
                            else if($index_%4==2)
                                echo '<div class="ad-square ad-regular" style="background-color: #F79696">';
                            else if($index_%4==3)
                                echo '<div class="ad-square ad-regular" style="background-color: #A0FC6B">';
                            else if($index_%4==0)
                                echo '<div class="ad-square ad-regular" style="background-color: #FDD863">';
