...
class JMultiSelectGroups extends CJuiInputWidget {
    ...
    function run() {
        ...
        if ($this->hasModel())
            echo CHtml::activeDropDownList($this->model,  $this->attribute, CHtml::listData(
                        $this->data, 'id', 'name', 'group'), $this->htmlOptions);
        else
