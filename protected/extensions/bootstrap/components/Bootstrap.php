...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerButton($selector = null, $options = array())
	{
        ...
        $this->registerAssetCss('bootstrap-toggle-buttons.css');
        $this->registerAssetJs('bootstrap-button.js');
	...
	public function registerModal($selector = null, $options = array())
	{
        ...
        $this->registerAssetJs('bootstrap-modal.js');
	}
	...
	public function registerPopover($selector = null, $options = array())
	{
        ...
        $this->registerAssetJs('bootstrap-popover.js');
	}
	...
	public function registerTooltip($selector = null, $options = array())
	{
        ...
        $this->registerAssetJs('bootstrap-tooltip.js');
	}
	...
	public function registerHtml5Editor($selector = null, $options = array())
	{
        ...
        $this->registerAssetCss('bootstrap-wysihtml5.css');
        $this->registerAssetJs('bootstrap-wysihtml5.js');
