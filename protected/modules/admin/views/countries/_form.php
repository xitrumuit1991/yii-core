	...
	<div class="panel-body">
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<div class='form-group form-group-sm'>
                <?php echo $form->labelEx($model,'area_name', array('class' => 'col-sm-1 control-label')); ?>
                <div class="col-sm-3">
                    <?php echo $form->textField($model,'area_name', array('class' => 'form-control', 'maxlength' => 255)); ?>
                    <?php echo $form->error($model,'area_name'); ?>
                </div>
            </div>
            <div class='form-group form-group-sm'>
                <?php echo $form->labelEx($model,'area_code', array('class' => 'col-sm-1 control-label')); ?>
                <div class="col-sm-3">
                    <?php echo $form->textField($model,'area_code', array('class' => 'form-control', 'maxlength' => 3)); ?>
