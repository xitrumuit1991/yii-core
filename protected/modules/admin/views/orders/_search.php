    ...
    <div class="panel-body">
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-7">
                    <?php echo $form->textField($model, 'from_date', array('class' => 'my-datepicker-control form-control', 'style' => 'width: 60%')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-7">
                    <?php echo $form->textField($model, 'to_date', array('class' => 'my-datepicker-control form-control', 'style' => 'width: 60%')); ?>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-7">
                    <?php echo $form->dropDownList($model, 'status', SpOrders::getListStatusOrderBE(), array('class' => 'form-control', 'empty' => 'All')); ?>
                </div>
            </div>
        </div>
