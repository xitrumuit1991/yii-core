<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title"><span class="<?php echo $model->isNewRecord ? $this->iconCreate : $this->iconEdit; ?>"></span> Update TopBannerRight</h3>
	</div>
	...
	if( !$model->isNewRecord)
    {
        ...
        <div class='form-group form-group-sm'>
			...
			Recommended Size: <?php echo TopBannerRight::WIDTH ?>px x <?php echo TopBannerRight::HEIGHT ?>px (width x height). Allow: *.jpg, *.png, *.gif
		...
		<div class='form-group form-group-sm'>
			...
			<div class="col-sm-6">
				...
				if(!empty($model->image)) 
					echo '<img src="'.ImageHelper::getImageUrl($model, 'image', TopBannerRight::SIZE ).'" />';
