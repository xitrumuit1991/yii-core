<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title"><span class="<?php echo $model->isNewRecord ? $this->iconCreate : $this->iconEdit; ?>"></span> Update ScrollBanner</h3>
	</div>
	...
	if( !$model->isNewRecord)
    {
        ...
        <div class='form-group form-group-sm'>
			...
			Recommended Size: <?php echo ScrollBanner::WIDTH ?>px x <?php echo ScrollBanner::HEIGHT ?>px (width x height). Allow: *.jpg, *.png, *.gif
		...
		<div class='form-group form-group-sm'>
			...
			<div class="col-sm-6">
				...
				{
					// echo $model->image;
					// echo ImageHelper::getImageUrl($model, 'image', ScrollBanner::SIZE );
					echo '<img src="'.ImageHelper::getImageUrl($model, 'image', ScrollBanner::SIZE ).'" />';
